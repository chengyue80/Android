...
/**
 * ShellUtils Android Shell工具类，可用于检查系统root权限，并在shell或root用户下执行shell命令。如：
 * checkRootPermission() 检查root权限 execCommand(String[] commands, boolean isRoot,
 * boolean isNeedResultMsg) shell环境执行命令，第二个参数表示是否root权限执行 execCommand(String
