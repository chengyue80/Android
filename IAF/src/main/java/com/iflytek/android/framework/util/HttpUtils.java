...
import com.iflytek.android.framework.util.entity.HttpRequest;
import com.iflytek.android.framework.util.entity.HttpResponse;

/**
 * HttpUtils Http网络工具类，主要包括httpGet、httpPost以及http参数相关方法，以httpGet为例： static
 * HttpResponse httpGet(HttpRequest request) static HttpResponse
 * httpGet(java.lang.String httpUrl) static String httpGetString(String httpUrl)
...
public class HttpUtils {
	...
	private static void setHttpResponse(HttpURLConnection urlConnection,
		...
		response.setResponseHeader(EXPIRES,
				urlConnection.getHeaderField("Expires"));
		response.setResponseHeader(CACHE_CONTROL,
