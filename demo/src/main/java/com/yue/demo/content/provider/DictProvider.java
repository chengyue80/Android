...
//
//import org.yue.mytest.content.Words;
//import org.yue.mytest.io.MyDatabaseHelper;
//
...
//        dbOpenHelper = new MyDatabaseHelper(this.getContext(), DB_NAME, null, 1);
//        return true;
//    }
//
...
//        // 如果操作的数据是多项记录
//        case WORDS:
//            return "vnd.android.cursor.dir/org.yue.dict";
//        // 如果操作的数据是单项记录
//        case WORD:
//            return "vnd.android.cursor.item/org.yue.dict";
//        default:
...
//            }
//            return db.query(TABLE_NAME, projection, whereClause, whereArgs,
//                    null, null, sortOrder);
//        default:
//            throw new IllegalArgumentException("未知Uri:" + uri);
//        }
