...
public class PinBall extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        gameView.setLayoutParams(new LayoutParams(900, 900));
        // gameView.
        ll.addView(gameView);
        setContentView(ll);
        // 创建GameView组件
        ...
        tableHeight = gameView.getHeight();
        tableWidth = gameView.getWidth();
        ...
        gameView.setOnKeyListener(new OnKeyListener() // ②
        {
            ...
            public boolean onKey(View source, int keyCode, KeyEvent event) {
                ...
                case KeyEvent.KEYCODE_VOLUME_DOWN:
                    LogUtil.d(MainActivity_Graphics.Tag + "VOLUME_DOWN");
                    Toast.makeText(PinBall.this, "VOLUME_DOWN",
    ...
    class GameView extends View {
        ...
        public void onDraw(Canvas canvas) {
            ...
            // 如果游戏还未结束
                ...
                canvas.drawText("音量上键向左，下键向右", 20, racketY + 20, paint);
            }
        }
    }
}