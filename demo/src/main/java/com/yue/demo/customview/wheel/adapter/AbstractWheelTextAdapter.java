...
public abstract class AbstractWheelTextAdapter extends AbstractWheelAdapter {
	...
	public static int textColor_current = DEFAULT_TEXT_COLOR;
	public static int textSize_current = DEFAULT_TEXT_SIZE;
		...
		if (index >= 0 && index < getItemsCount()) {
			...
			if (textView != null) {
				...
				if (itemResourceId == TEXT_VIEW_ITEM_RESOURCE) {
					// System.out.println("from getItem");
	...
	public View getEmptyItem(View convertView, ViewGroup parent) {
		...
		if (emptyItemResourceId == TEXT_VIEW_ITEM_RESOURCE
			...
			System.out.println("from getEmptyItem");
	 ...
	 */
	public void configureTextView(TextView view, int index) {
		...
		if (textColors != null) {
			...
			if (index == currentItem) {
				view.setTextColor(textColor_current);
				view.setTextSize(textSize_current);
